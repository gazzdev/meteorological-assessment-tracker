...
/******/
{
  ...
  /***/
  function node_modulesNgtoolsWebpackSrcIndexJsSrcAppTrackerWebWorkersTrackerCalculateWorkerTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_helpers_load_area_data_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/helpers/load-area-data.helper */
    "./src/app/helpers/load-area-data.helper.ts"); /// <reference lib="webworker" />
    ...
    addEventListener('message', function (_ref) {
      ...
      regeneratorRuntime.mark(function _callee() {
        var loadAreaDataHelper, maxWindspeed, maxRainfall, maxTideHeight, daylightOnly, areaData, result;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                loadAreaDataHelper = new src_app_helpers_load_area_data_helper__WEBPACK_IMPORTED_MODULE_1__["LoadAreaDataHelper"]();
                maxWindspeed = data.maxWindspeed;
                maxRainfall = data.maxRainfall;
                maxTideHeight = data.maxTideHeight;
                daylightOnly = data.daylightOnly;
                areaData = data.data;
                _context.next = 8;
                return loadAreaDataHelper.calculateHours(maxWindspeed, maxRainfall, maxTideHeight, daylightOnly, areaData, postMessage);
  ...
  /***/
  function srcAppHelpersLoadAreaDataHelperTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoadAreaDataHelper", function () {
      return LoadAreaDataHelper;
    });
    /* harmony import */
    ...
    var LoadAreaDataHelper =
    /*#__PURE__*/
    function () {
      function LoadAreaDataHelper() {
        _classCallCheck(this, LoadAreaDataHelper);
      }

      _createClass(LoadAreaDataHelper, [{
        key: "calculateHours",
        ...
        //     });
        //   }
        value: function calculateHours(maxWindspeed, maxRainfall, maxTideHeight, daylightOnly, data, postMessage) {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              this.calculateDay(maxWindspeed, maxRainfall, maxTideHeight, daylightOnly, day, postMessage); // let sunrise = day.Sunrise;
        ...
        key: "calculateDay",
        value: function calculateDay(maxWindspeed, maxRainfall, maxTideHeight, daylightOnly, // fromDate: Date,
        // toDate: Date,
        day, postMessage) {
          postMessage("Progress: day ".concat(day.date)); // filter results by to and from date

          var rainfall = day.rainfall.filter(function (x) {
            return x.Rainfall <= maxRainfall;
          });
          var tide = day.tide.filter(function (x) {
            return x.TideHeight <= maxTideHeight && !isNaN(x.TideHeight);
          });
          var wind = day.weather.filter(function (x) {
            return x.WindSpeed <= maxWindspeed && !isNaN(x.WindSpeed);
          }); // wind between these times

          if (daylightOnly) {
            wind = day.weather.filter(function (x) {
              return x.Timestamp >= day.dayLight.Sunrise && x.Timestamp <= day.dayLight.Sunset;
            });
            tide = day.tide.filter(function (x) {
              return x.Timestamp >= day.dayLight.Sunrise && x.Timestamp <= day.dayLight.Sunset;
            });
            rainfall = day.rainfall.filter(function (x) {
              return x.Timestamp >= day.dayLight.Sunrise && x.Timestamp <= day.dayLight.Sunset;
            });
          } // for each hour in the day
          ...
          var _loop = function _loop(hour) {
            var hourWind = wind.filter(function (x) {
              return x.Timestamp.getHours() === hour;
            });
            var hourTide = tide.filter(function (x) {
              return x.Timestamp.getHours() === hour;
            });
            var hourRainfall = rainfall.filter(function (x) {
              return x.Timestamp.getHours() === hour;
            });
          ...
          for (var hour = day.dayLight.Sunrise.getHours(); hour <= day.dayLight.Sunset.getHours(); hour++) {
            _loop(hour);
          }
